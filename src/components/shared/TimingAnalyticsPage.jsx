...
import styles from './TimingAnalyticsPage.module.css'

function TimingAnalyticsPage({ onGoHome }) {
      ...
      <main className={styles.examContent}>
        <div className={styles.examInfo}>
          ...
          <p className={styles.examDescription}>
            Analyze your exam performance with detailed timing insights and statistics.
          </p>
...
export default TimingAnalyticsPage